        ...
        if multiSelectEnabled {
            ...
            if cell.accessoryType == UITableViewCellAccessoryType.checkmark {
               ...
               // let trimmedString = string.trimmingCharacters(in: .whitespaces)
                ...
                {
//                    let trimmedStringForName = selectedContact.firstName.replacingOccurrences(of: " ", with: "")
//                    let trimmedStringForName1 = selectedContacts[i].firstName.replacingOccurrences(of: " ", with: "")//selectedContacts[i].firstName.trimmingCharacters(in: .whitespaces)
                    
                    for conta in selectedContact.phoneNumbers{
                    let trimmedStringForPhoneNumber = conta.phoneNumber.replacingOccurrences(of: " ", with: "")
                       // let trimmedStringForName = selectedContact.firstName.replacingOccurrences(of: " ", with: "")
                       // for j in 0..<selectedContacts[i].phoneNumbers{
                        for conta1 in  selectedContacts[i].phoneNumbers{
                         //   let trimmedStringForName1 = selectedContacts[i].firstName.replacingOccurrences(of: " ", with: "")
                            let trimmedStringForPhoneNumber1 = conta1.phoneNumber.replacingOccurrences(of: " ", with: "")
                            
//                           let trimmedStringForPhoneNumber11 = trimmedStringForPhoneNumber1.components(separatedBy: ":")
               if /*trimmedStringForName == trimmedStringForName1  ||*/ trimmedStringForPhoneNumber == trimmedStringForPhoneNumber1 // selectedName[i]
               {
